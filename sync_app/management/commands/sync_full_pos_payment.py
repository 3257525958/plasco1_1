...
class Command(BaseCommand):
    help = 'انتقال کامل تمام داده‌های pos_payment از سرور به لوکال'
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write("🚀 شروع انتقال کامل pos_payment از سرور به لوکال...")
        ...
        for model_name in models_to_sync:
            try:
                model_class = apps.get_model('pos_payment', model_name)
    ...
    def sync_model_data(self, model_class):
        ...
        try:
            ...
            response = requests.get(
                ...
                params={'app': 'pos_payment', 'model': model_class.__name__},
                timeout=60
            )
        ...
        for record_data in records:
            try:
                ...
                if saved_count <= 10:  # فقط 10 تا اول را نمایش بده
                    ...
                    self.stdout.write(f"📝 {action}: pos_payment.{model_class.__name__} - ID: {record_id}")
    ...
    def process_record_data(self, record_data, model_class):
        ...
        for field_name, value in record_data.items():
            ...
            if isinstance(value, (int, float)) and self.is_decimal_field(model_class, field_name):
    ...
    def show_final_status(self):
        """نمایش وضعیت نهایی pos_payment"""
        try:
            from pos_payment.models import POSTransaction

            self.stdout.write(f"\n📋 وضعیت نهایی pos_payment:")
